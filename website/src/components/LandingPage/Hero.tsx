...
export function Hero() {
  return (
    <div className="pb-16 pt-20 text-center lg:pt-32">
      ...
      >
        Save Hours with our AI Tools for{" "}
        <span className="relative whitespace-nowrap text-orange">
          ...
          <span className="relative text-orange-500">Business Analysis</span>
        </span>
      </motion.h1>
      <motion.p
        initial={{ opacity: 0, y: 20 }}
      ...
      >
        Generate <b>comprehensive</b> SWOT, PESTEL analyses and user personas{" "}
        <b>effortlessly</b>
      </motion.p>
      <motion.div
        initial={{ opacity: 0, y: 20 }}
