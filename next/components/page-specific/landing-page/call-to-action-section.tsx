    ...
    <section id="get-started-today" className="relative bg-white py-32">
      <Container className="relative mt-[100px]">
        <div className="mx-auto max-w-lg text-center">
          ...
          <div className="mb-10 mt-4 text-lg tracking-tight text-black">
            <p>
              How many hours does it cost you to create content that
              doesn&apos;t convert because you don&apos;t understand your
              audience? <br></br>
            </p>
            <br></br>
            <br></br>
