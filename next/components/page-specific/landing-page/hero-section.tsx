    ...
    <div className="pb-16 pt-20 text-center lg:pt-32">
      ...
      >
        ...
        <span className="text-green relative whitespace-nowrap">
          ...
          <span className="relative text-green-500">fast</span>
        </span>
      </motion.h1>
      <motion.p
        initial={{ opacity: 0, y: 20 }}
      ...
      >
        Generate <b>comprehensive user personas</b> quickly and effortlessly.
        Get deep insights and supercharge your SEO. Marketing Managers and
        businesses can <b>save hours</b>.
      </motion.p>
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
