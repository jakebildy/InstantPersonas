        ...
        <div className="flex flex-row">
          <div>
            <div className="flex flex-row">
              ...
              />
              <button className="bg-green-500 text-white p-2 rounded-md mt-10 h-min ml-[200px]">
                Analyze Headline
              </button>
            </div>
          ...
          <div className="border border-gray-300 rounded-md  bg-white mt-[80px] ml-[20px] w-[300px]">
            {isSubscribed ? (
